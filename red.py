...
#
# Crank is a multifunction Discord bot by PaPí#2888.
#
#                   Official Server Invite : https://discord.gg/BkR9ZmR
#

description = "Crank is a fully multifunctional bot for  discord server.It includes of features such as moderation, auto moderation, role management, custom commands, music, and many more. Made by : PaPí#2888. Invite it and enjoy "
...
class Bot(commands.Bot):
    ...
    async def shutdown(self, *, restart=False):
        """Gracefully quits Crank with exit code 0
...
def initialize(bot_class=Bot, formatter_class=Formatter):
    ...
    async def on_ready():
        ...
        print("\nOfficial server: https://discord.gg/BkR9ZmR")
...
def check_folders():
    folders = ("data", "data/Crank", "cogs", "cogs/utils")
...
def interactive_setup(settings):
    ...
    if first_run:
        print("Crank - First run configuration\n")
    ...
    if first_run:
        ...
        print("\nThe configuration is done. Leave this window always open to"
              ...
              "Please make sure to join the official Crank server:\n"
              "https://discord.gg/BkR9ZmR"
...
def load_cogs(bot):
    ...
    if owner_cog is None:
        print("The owner cog is missing. It contains core functions without "
              "which Crank cannot function. Reinstall.")
        exit(1)
